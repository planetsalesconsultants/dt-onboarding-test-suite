...
const Tab = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      }, role: "tab", "aria-disabled": disabled ? 'true' : 'false', "aria-selected": active ? 'true' : 'false', tabIndex: disabled || !active ? 0 : null, onFocus: this.onFocus, onBlur: this.onBlur, slot: "nav" }, index.h("slot", null)));
  }
...
const TabGroup = class {
  ...
  setActiveTab(tab, options) {
    ...
    if (tab !== this.activeTab) {
      ...
      if (['top', 'bottom'].includes(this.placement)) {
        scroll.scrollIntoView(this.activeTab, nav, 'horizontal', options.scrollBehavior);
      }
      // Emit events/
  ...
  render() {
    ...
    return (index.h("div", { class: {
      ...
      }, onClick: this.handleClick }, index.h("div", { class: "tab-group__nav-container", part: "nav" }, index.h("div", { class: "tab-group__nav" }, index.h("div", { part: "tabs", class: { 'tab-group__tabs': true, [`tab-${tabSize}`]: true, }, role: "tablist" }, index.h("div", { part: "active-tab-indicator", class: "tab-group__indicator" }), index.h("slot", { name: "nav", onSlotchange: this.handleTabsPanelsChange })))), index.h("div", { part: "body", class: "tab-group__body" }, index.h("slot", { onSlotchange: this.handleTabsPanelsChange }))));
  }
  get el() { return index.getElement(this); }
...
const TabPanel = class {
  ...
  render() {
    ...
    return (index.h("div", { part: "base", class: "tab-panel", role: "tabpanel", "aria-hidden": active ? 'false' : 'true' }, index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
...
exports.gr_tab = Tab;
exports.gr_tab_group = TabGroup;
exports.gr_tab_panel = TabPanel;

//# sourceMappingURL=gr-tab_3.cjs.entry.js.map