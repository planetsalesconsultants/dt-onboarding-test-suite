...
const Radio = class {
  ...
  connectedCallback() {
    ...
    if (radioGroup) {
      this.updateState();
      helpers.addEventListener(radioGroup, 'gr-change', this.updateState);
      // Needed for the Vue wrappers
      helpers.addEventListener(radioGroup, 'v-gr-change', this.updateState);
    }
  }
  componentWillLoad() {
  ...
  disconnectedCallback() {
    ...
    if (radioGroup) {
      helpers.removeEventListener(radioGroup, 'gr-change', this.updateState);
      // Needed for the Vue wrappers
      helpers.removeEventListener(radioGroup, 'v-gr-change', this.updateState);
      this.radioGroup = null;
    }
  }
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({ class: {
      ...
      }, tabindex: this.buttonTabindex, role: "radio", onBlur: this.handleBlur, onFocus: this.handleFocus, "aria-checked": `${this.checked}`, "aria-hidden": this.disabled ? 'true' : null }, ariaLabelAttributes), index.h("label", { class: {
        'radio': true,
        'radio-checked': this.checked,
        'radio-disabled': this.disabled,
        'radio-focused': this.hasFocus,
        [`radio-${this.alignment}`]: true,
      }, htmlFor: this.inputId }, index.h("span", { class: "radio-control" }, index.h("span", { class: "radio-icon" }, index.h("svg", { role: "img", "aria-hidden": "true", viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { fill: "currentColor" }, index.h("circle", { cx: "8", cy: "8", r: "3.42857143" }))))), index.h("input", { ref: el => (this.input = el), id: this.inputId, type: "radio", value: this.value, checked: this.checked, disabled: this.disabled, tabindex: "-1" })), index.h("span", { id: this.labelId, class: "radio-label" }, index.h("slot", null)))));
  }
...
const RadioGroup = class {
  ...
  render() {
    helpers.renderHiddenInput(this.el, this.name, this.value, false);
    ...
    return (index.h(index.Host, { onClick: this.onClick }, index.h("fieldset", { class: {
        'radio-group': true,
      ...
      }, role: "radiogroup", "aria-invalid": this.invalid, "aria-required": this.requiredIndicator ? 'true' : 'false', "aria-describedby": this.invalid ? this.invalidTextId : '' }, index.h("legend", { class: "radio-group-label", "aria-hidden": hasLabel ? 'false' : 'true' }, index.h("slot", { name: "label" }, this.label), this.requiredIndicator && (index.h("span", { class: "asterisk" }, index.h("svg", { role: "img", "aria-hidden": "true", viewBox: "0 0 1200 1200" }, index.h("path", { fill: "currentColor", d: "M489.838 29.354v443.603L68.032 335.894 0 545.285l421.829 137.086-260.743 358.876 178.219 129.398L600.048 811.84l260.673 358.806 178.146-129.398-260.766-358.783L1200 545.379l-68.032-209.403-421.899 137.07V29.443H489.84l-.002-.089z" }))))), index.h("div", { class: "content" }, index.h("slot", null)), showInvalidText && (index.h("div", { id: this.invalidTextId, class: "radio-group-invalid-text", "aria-hidden": hasInvalidText ? 'false' : 'true' }, index.h("div", { class: "icon" }, index.h("svg", { role: "img", "aria-hidden": "true", viewBox: "0 0 512 512" }, index.h("title", null, "Alert Circle"), index.h("path", { d: "M256,48C141.31,48,48,141.31,48,256s93.31,208,208,208,208-93.31,208-208S370.69,48,256,48Zm0,319.91a20,20,0,1,1,20-20A20,20,0,0,1,256,367.91Zm21.72-201.15-5.74,122a16,16,0,0,1-32,0l-5.74-121.94v-.05a21.74,21.74,0,1,1,43.44,0Z", fill: "currentColor" }))), index.h("div", { class: "text" }, index.h("slot", { name: "invalid-text" }, this.invalidText)))))));
  }
  get el() { return index.getElement(this); }
...
exports.gr_radio = Radio;
exports.gr_radio_group = RadioGroup;

//# sourceMappingURL=gr-radio_2.cjs.entry.js.map