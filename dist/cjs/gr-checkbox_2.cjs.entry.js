...
const Checkbox = class {
  ...
  render() {
    helpers.renderHiddenInput(this.el, this.name, this.checked ? this.value : '', this.disabled);
    ...
    return (index.h(index.Host, { class: {
      ...
      }, htmlFor: this.inputId, onMouseDown: this.handleMouseDown }, index.h("span", { class: "checkbox-control" }, this.checked && (index.h("span", { class: "checkbox-icon" }, index.h("svg", { role: "img", "aria-hidden": "true", viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" }))))))), !this.checked && this.indeterminate && (index.h("span", { class: "checkbox-icon" }, index.h("svg", { role: "img", "aria-hidden": "true", viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(2.285714, 6.857143)" }, index.h("path", { d: "M10.2857143,1.14285714 L1.14285714,1.14285714" }))))))), index.h("input", Object.assign({ ref: el => (this.input = el), id: this.inputId, type: "checkbox", value: this.value, checked: this.checked, disabled: this.disabled, role: "checkbox", "aria-invalid": this.invalid, "aria-checked": this.checked ? 'true' : 'false' }, ariaLabelAttributes, { "aria-describedby": this.invalid ? this.invalidTextId : '', onClick: this.handleClick, onBlur: this.handleBlur, onFocus: this.handleFocus }))), index.h("span", { id: this.labelId, class: "checkbox-label" }, index.h("slot", null))), showInvalidText && (index.h("div", { id: this.invalidTextId, class: "checkbox-invalid-text", "aria-hidden": hasInvalidText ? 'false' : 'true' }, index.h("div", { class: "icon" }, index.h("svg", { role: "img", "aria-hidden": "true", viewBox: "0 0 512 512" }, index.h("title", null, "Alert Circle"), index.h("path", { d: "M256,48C141.31,48,48,141.31,48,256s93.31,208,208,208,208-93.31,208-208S370.69,48,256,48Zm0,319.91a20,20,0,1,1,20-20A20,20,0,0,1,256,367.91Zm21.72-201.15-5.74,122a16,16,0,0,1-32,0l-5.74-121.94v-.05a21.74,21.74,0,1,1,43.44,0Z", fill: "currentColor" }))), index.h("div", { class: "text" }, index.h("slot", { name: "invalid-text" }, this.invalidText))))));
  }
...
const FieldGroup = class {
  ...
  render() {
    ...
    return (index.h("fieldset", { class: {
      ...
      } }, index.h("legend", { class: "field-group-label", "aria-hidden": hasLabel ? 'false' : 'true' }, index.h("slot", { name: "label" }, this.label)), index.h("div", { class: "content" }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
exports.gr_checkbox = Checkbox;
exports.gr_field_group = FieldGroup;

//# sourceMappingURL=gr-checkbox_2.cjs.entry.js.map